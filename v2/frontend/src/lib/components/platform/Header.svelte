<script>
  import { logout, user } from '$lib/stores/userStore.js';
  ...
  import logo from '$lib/assets/datasetICON.png';

  let searchQuery = $state('');

  export const pathname = writable(browser ? window.location.pathname : '');
