        ...
        <div class="flex-1 flex flex-col items-center space-y-2">
          <div class="w-full flex flex-col items-center">
            ...
            <div class="w-full h-4 bg-teal-500 rounded-b relative group">
              <div
                class="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity"
              >
                {data.sales} sales
              </div>
            </div>
